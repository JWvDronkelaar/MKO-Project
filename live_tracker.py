# This is old but used as a reference for both functionality and speed
...
from viz.visualizer import draw_fps
...
MODEL = "models/yolo11n.pt"     # mensen-detectie; CPU ok
CONF_THRES = 0.1
IOU_THRES = 0.5
SAVE_JSONL = False
...
try:
    ...
    while True:
        ...
        # 1) detect
        res = model.predict(source=frame, verbose=False, conf=CONF_THRES, iou=IOU_THRES, device="cuda")[0]
